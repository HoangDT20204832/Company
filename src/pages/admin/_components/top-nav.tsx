import {
  ...
  QuestionAnswerTwoTone as QuestionAnswerIcon,
...
export const TopNav = (props: TTopNavProps) => {
  ...
  return (
    <>
        ...
        >
          ...
          <Stack alignItems="center" direction="row" spacing={2}>
            <IconButton
              ...
              onClick={chatPopover.handleOpen}
              ref={chatPopover.anchorRef}
            >
              <QuestionAnswerIcon fontSize="inherit" />
            </IconButton>

            <Tooltip title={t('Thông báo')}>
              <IconButton
                sx={{
                  color: TEXT_COLOR,
                }}
            ...
            >
              <AvatarStyled src={authState.currentUser?.imageUrl} />
            </IconButton>
          </Stack>
        </Stack>
      </Box>
      ...
      />
      <ChatPopover
        anchorEl={chatPopover.anchorRef.current}
        open={chatPopover.open}
        onClose={chatPopover.handleClose}
      />
      <NotificationPopover
